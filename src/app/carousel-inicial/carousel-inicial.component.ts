...
@Component({
  selector: 'carousel-inicial',
  templateUrl: './carousel-inicial.component.html',
  styleUrls: ['./carousel-inicial.component.scss'],
  providers:[{ provide: CarouselConfig, useValue: { animation: true, interval: 3000, pauseOnHover: true, showIndicators: true, showNavigationArrows: true } }]
})
